...
// ------------------------------------------------------------------------------------------- 以下内容需要自己替换
const subSiteAuthor = 'Matthew';
const subSiteKeywords = `article-tips,article-knowledge,article-files,article-posts,article-helps` + ','; // 关键字，多个关键字用逗号分隔
const indexNowKey = 'f5ac4ad2061341fa91ef24364c01e78b'; // 替换为你的API密钥
